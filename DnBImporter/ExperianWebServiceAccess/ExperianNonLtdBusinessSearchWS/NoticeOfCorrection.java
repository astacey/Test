 ...
 *         &lt;element name="NOCDetail" type="{http://schema.uk.experian.com/experian/bi/generic/business/bsns/v100/basetypes}NoticeOfCorrectionData" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class NoticeOfCorrection {
    ...
    protected List<NoticeOfCorrectionData> nocDetail;
     ...
     * {@link NoticeOfCorrectionData }
     * 
     * 
     */
    public List<NoticeOfCorrectionData> getNOCDetail() {
        if (nocDetail == null) {
            nocDetail = new ArrayList<NoticeOfCorrectionData>();
        }
