...
public class TestDnBDataMapper {
	...
	public void testGetDnBDataFromXml() 
	{
		...
		assertEquals("Address lines 0 is right", "ST GEORGES HALL & Test", data.getMainAddress().getAddressLines().get(0));
